...
import 'package:finwise/features/Transaction/presentation/cubit/transaction_filter_helper.dart';
import 'package:finwise/features/Transaction/presentation/cubit/transaction_stats_helper.dart';
...
class TransactionCubit extends Cubit<TransactionStates> {
  ...
  List<TransactionModel> _applyFiltersLocally({
    ...
    return TransactionFilterHelper.applyFiltersLocally(
  ...
  double get monthlyExpenses =>
      TransactionStatsHelper.calculateMonthlyExpenses(statsTransactionsList);
