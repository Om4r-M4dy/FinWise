...
void showAddGoalBottomSheet(
  ...
  showModalBottomSheet(
    ...
    builder: (sheetContext) {
      ...
      final bool sheetIsDark = sheetTheme.brightness == Brightness.dark;
      final double progress = goal != null
          ? (goal.targetAmount > 0
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      goal != null ? "Edit Goal" : "Add Goal Target",
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: goal != null
                        ? "Target Name"
                        : "Target Name (e.g. Travel, Car, New House)",
                      ...
                      if (formKey.currentState!.validate()) {
                        ...
                        if (userId != null) {
                          if (goal != null) {
                            ...
                            if (goalCubit.goalsList.length >= 5) {
                              showMyDialog(
                                context,
